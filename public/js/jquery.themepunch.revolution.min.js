...
/***/ "./resources/ass/js/jquery.themepunch.revolution.min.js":
/*!**************************************************************!*\
  !*** ./resources/ass/js/jquery.themepunch.revolution.min.js ***!
  \**************************************************************/
...
(function (e, t) {
  ...
  e.fn.extend({
    revolution: function revolution(t) {
      defaults = {
        delay: 9e3,
        startheight: 500,
        startwidth: 960,
  ...
  var k = function k(n, r, i, s, u, a) {
    ...
    if (f == 6) {
      ...
      a.find(".slotslide").each(function (t) {
        var o = e(this);
        if (t < r.slots / 2) var f = (t + 2) * 60;else var f = (2 + r.slots - t) * 60;
    ...
    if (f == 12 || f == 13 || f == 14 || f == 15) {
      ...
      var H = 0;
      var j = 0;
      if (f == 12) H = _;else if (f == 15) H = 0 - _;else if (f == 13) j = D;else if (f == 14) j = 0 - D;
      var F = 1;
      var I = 1;
      var q = 1;
  ...
  var B = function B(n, r, i) {
    ...
    u.each(function (n) {
      ...
      if (h == 0) {
        ...
        if (f.data("x") == "center" || f.data("xcenter") == "center") var J = f.data("x") + s;else {
          var J = l * f.data("x") + s;
        }
        if (f.data("y") == "center" || f.data("ycenter") == "center") var K = f.data("y") + o;else {
        ...
        if (!u) {
          ...
          if (a != 2) {
            if (f.hasClass("customin")) {
              ...
              if (Z != f) Y.add(TweenLite.set(f, (_TweenLite$set = {
                opacity: 1,
                scaleX: 1,
                scaleY: 1,
                rotationX: 0,
              ...
              if (Z != f) Y.add(TweenLite.set(f, (_TweenLite$set2 = {
                opacity: 1,
                scaleX: 1,
                scaleY: 1,
                rotationX: 0,
          ...
          if (f.data("end") != t && (a == -1 || a == 2)) {
            ...
            if (a == -1 || a == 2) W(f, r, 999999, et, "frame99", l);else W(f, r, 200, et, "frame99", l);
          }
...
/***/ 9:
/*!********************************************************************!*\
  !*** multi ./resources/ass/js/jquery.themepunch.revolution.min.js ***!
  \********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\xampp3\htdocs\firstlaravel\resources\ass\js\jquery.themepunch.revolution.min.js */"./resources/ass/js/jquery.themepunch.revolution.min.js");
