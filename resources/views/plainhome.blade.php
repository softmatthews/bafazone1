...
<!-- Mirrored from demo.tadathemes.com/html_ultrastore/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 30 Jan 2020 13:03:52 GMT -->
<head>    
	...
	<div id="CartDrawer" class="drawer drawer--right drawer--has-fixed-footer" tabindex="-1">
		...
		<div class="drawer__inner">
			<div id="CartContainer" class="drawer__cart">
				<form action="http://demo.tadathemes.com/html_ultrastore/cart.html" method="post" novalidate="" class="cart ajaxcart">
			...
			<div id="html-section-header" class="html-section">
				<div class="topinfom small--hide">
					<div class="topinfo-text" style="background-color:#cccccc">
						<div class="wrapper">
							<a href="collection.html">Happy New year Holiday with 30% off, use code 'newyear2020' in Checkout page</a>
						</div>
					</div>
				</div>
							...
							<div class="site-nav__item nav-language medium-down--hide">
								<div class="switcher notranslate">
									<div class="selected lang-switcher">
										<a href="index-2.html"><img src="assets/images/en.png" height="16" width="16" alt="en"> English</a>
									</div>
									<div class="option">
										<a href="index-2.html" title="English" class="lang-sub selected"><img src="assets/images/en.png" height="16" width="16" alt="en"> English</a>
										<a href="index-2.html" title="French" class="lang-sub"><img src="assets/images/fr.png" height="16" width="16" alt="fr"> French</a>
										<a href="index-2.html" title="German" class="lang-sub"><img src="assets/images/de.png" height="16" width="16" alt="de"> German</a>
										<a href="index-2.html" title="Italian" class="lang-sub"><img src="assets/images/it.png" height="16" width="16" alt="it"> Italian</a>
										<a href="index-2.html" title="Russian" class="lang-sub"><img src="assets/images/ru.png" height="16" width="16" alt="ru"> Russian</a>
										<a href="index-2.html" title="Spanish" class="lang-sub"><img src="assets/images/es.png" height="16" width="16" alt="es"> Spanish</a>
									</div>
								</div>																							
							</div>
							<div class="site-nav__item nav-currency medium-down--hide">
							    <div class="switcher notranslate">
									<div class="selected currency-switcher">
										<a href="index-2.html"><img src="assets/images/usd.png" height="16" width="16" alt="en"> US Dollar</a>
									</div>
									<div class="option">
										<a href="index-2.html" title="English" class="curr-sub selected"><img src="assets/images/usd.png" height="16" width="16" alt="en"> USD</a>
										<a href="index-2.html" title="French" class="curr-sub"><img src="assets/images/euro.png" height="16" width="16" alt="en"> Euro</a>
										<a href="index-2.html" title="German" class="curr-sub"><img src="assets/images/pound.png" height="16" width="16" alt="en"> Pound</a>
										<a href="index-2.html" title="Italian" class="curr-sub"><img src="assets/images/yen.png" height="16" width="16" alt="en"> Yen</a>																				
									</div>
								</div>	
							</div>
												...
												<div class="row-1">
													<ul>
														...
														<li class="sub"><ul>
															...
															<li class="site-nav__link"><a href="collection-2.html">Electronic Cigarettes</a></li>
												...
												<div class="row-1">
													<ul>
														...
														<li class="sub"><ul>
															...
															<li class="site-nav__link">
																<a href="collection-2.html">Baby Rompers</a>
															</li>
															<li class="site-nav__link">
											...
											<li class="column-1 grid__item one-third">
												...
												<div class="row-2">
													<ul>
														...
														<li class="sub"><ul>
															<li class="site-nav__link">
																<a href="collection-2.html">Lace Front Wigs</a>
															</li>
															<li class="site-nav__link">
							...
							<div class="brandslider home-brandslider">
								<div class="brand-elemet">
									<a href="collection.html">
										<img src="assets/images/brandx.png" alt="">
									</a>
								</div>
								<div class="brand-elemet">
									<a href="collection.html">
...
<!-- Mirrored from demo.tadathemes.com/html_ultrastore/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 30 Jan 2020 13:10:18 GMT -->
</html>